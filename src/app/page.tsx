                ...
                <>
                  {!streamingState.currentResponse || streamingState.currentResponse.trim().length === 0 ? (
                      ...
                      <div className="max-w-4xl mx-auto">
                        <div className="flex justify-start gap-3">
                          ...
                          <div className="max-w-[70%]">
                            <div className="rounded-lg px-3 py-2 bg-gradient-to-r from-blue-50 to-purple-50 border border-blue-200 shadow-sm">
                    ...
                    <StreamingMessage
                      ...
                      previousResponses={streamingState.previousResponses}
                      isComplete={false}
